...
public:
	 ...
	 * @param font Pointer to the font used for text
	 */
	void drawSoundSettingsMenuAndHandleInput(BITMAP* buffer, BITMAP* backgroundBitmap, BITMAP* bannerBitmap, FONT* font);
private:
	GameState* gameState;
